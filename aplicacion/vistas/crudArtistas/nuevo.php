<br><br>
<?php 
// Nota: en un futuro, al registrar un artista nuevo se pedirá una contraseña para
// poder crear un registro en la tabla acl_usuarios, pero de momento la contraseña
// será la misma que el nombre
...
CHTML::dibujaEtiqueta("h1", [], "Crear artista").
...
echo CHTML::campoBotonSubmit("Crear",["class"=>"btn btn-danger"]) . "<br>" . PHP_EOL;
