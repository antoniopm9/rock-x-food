...
abstract class CACLBase {
    ...
    abstract public function getBorrado($nick);
    abstract public function getUsuarioRole($nick);
    abstract public function setNombre($nick, $nombre);
    abstract public function setContrasenia($nick, $contra);
    abstract public function setBorrado($nick,$borrado);
    abstract public function setUsuarioRole($nick,$role);
